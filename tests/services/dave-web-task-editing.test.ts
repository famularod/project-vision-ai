...
describe('DAVE desktop task editing model', () => {
  test('resolves task authority by immutable project id without same-name fallback', () => {
    const projectRecords = [
      { id: 'project-a', name: 'Shared Project' },
      { id: 'project-b', name: 'Shared Project' },
      { id: 'project-c', name: 'Unique Project' },
    ];

    expect(resolveExactDAVEWebTaskProjectId({
    ...
    expect(resolveExactDAVEWebTaskProjectId({
      ...
      projectRecords: [{ id: 'project-a', name: 'Renamed Project' }],
    })).toBe('project-a');
    expect(resolveExactDAVEWebTaskProjectId({
      projectName: 'Shared Project',
      current: {
