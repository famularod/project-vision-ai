  ...
  return rawItems
    .map(raw => {
      ...
      return normalizeScheduleItem({
        ...
        startDate: normalizeAiScheduleDate(item.startDate),
        finishDate: normalizeAiScheduleDate(item.finishDate),
        ...
        notes:
          typeof item.notes === 'string' && item.notes.trim()
            ? `${item.notes.trim()} Review this AI-extracted item before relying on it.`
            : 'AI/OCR extraction from imported Gantt PDF. Review task name, location, and dates before relying on this item.',
        importedFrom: sourceName,
        importedAt,
      });
    })
