...
const liveAuthorityEvidence = read('services/PIELiveAuthorityProjectEvidence.ts');
...
assert(
  app.includes('const authorityEvidence = buildExactPIELiveAuthorityProjectEvidence({') &&
    app.includes("projectAreas: authorityEvidence.projectAreas as unknown as PIELiveAuthorityInput['projectAreas']") &&
    app.includes("referenceDocuments: authorityEvidence.referenceDocuments as unknown as PIELiveAuthorityInput['referenceDocuments']") &&
    app.includes("projectDocuments: authorityEvidence.projectDocuments as unknown as PIELiveAuthorityInput['projectDocuments']") &&
    app.includes('captureMemories: authorityEvidence.captureMemories') &&
    app.includes('updates={liveAuthorityInput.updates') &&
    app.includes('referenceDocuments={liveAuthorityInput.referenceDocuments') &&
    liveAuthorityEvidence.includes('if (input.reportScope) {') &&
    liveAuthorityEvidence.includes('return copyReportScope(input.reportScope);') &&
    liveAuthorityEvidence.includes('referenceDocuments: [...scope.referenceDocuments]') &&
    liveAuthorityEvidence.includes('projectDocuments: [...scope.projectDocuments]') &&
