...
assert(
  bottomNav.includes('label="Overview"') &&
    ...
    bottomNav.includes('Talk') &&
    bottomNav.includes('label="Ask ECOS"') &&
  ...
  'Live bottom actions must expose Overview, Tasks, Talk, Ask ECOS, and Reports while Settings remains reachable from Overview.',
);
