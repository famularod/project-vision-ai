...
const correctedProject = memory.correctCaptureMemoryProject(
  draft, 'project-canopy-c', 'Canopy C', '2026-07-12T08:01:00.000Z',
);
assert.strictEqual(correctedProject.projectId, 'project-canopy-c');
...
const ambiguous = memory.createCaptureMemory({ id: 'memory-2', projectId: 'project-unassigned', transcript: 'They will call tomorrow.', transcriptSourceRecordId: 't2', createdAt: '2026-07-12T09:00:00.000Z' });
