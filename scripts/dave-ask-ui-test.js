...
assert(app.includes('function reportTalkAnswerPersistenceFailure(projectId: string, error: unknown)'));
assert(app.includes('storageKey: daveAskHistoryStorageKey(projectId)'));
assert(app.includes('reportTalkAnswerPersistenceFailure(projectId, error)'));
