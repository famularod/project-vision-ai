...
const layers = [
  ...
  layer('Build 160 database migration evidence', 'check:ecos-build160-migration-evidence', 2),
  layer('Cover hardening database transition evidence', 'check:cover-hardening-migration-evidence', 2),
  layer('Managed source provenance ACL transition evidence', 'check:source-provenance-acl-migration-evidence', 2),
  layer('Ask ECOS live real-world acceptance', 'check:ecos-ask:live-evidence', 2),
  layer('Ask ECOS 2321 live real-world acceptance', 'check:ecos-ask:2321-live-evidence', 2),
