...
const talkIntelligence = read('services/ECOSTalkProjectIntelligence.ts');
...
const checks = [
  ...
  ['Ask DAVE uses Project Truth builder',
    app.includes('return buildECOSTalkProjectIntelligence({') &&
      talkIntelligence.includes('return buildDAVEProjectTruth({')],
