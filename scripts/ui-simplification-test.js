...
assert(bottomNav.includes('label="Ask ECOS"'), 'bottom nav should expose the approved read-only project question action');
...
assert((bottomNav.match(/<TabButton/g) || []).length === 4, 'bottom nav should have four distinct navigation tabs plus Talk');
assert(bottomNav.indexOf('label="Overview"') < bottomNav.indexOf('label="Tasks"'), 'Overview should precede Tasks');
assert(bottomNav.indexOf('label="Tasks"') < bottomNav.indexOf('onPress={onTalk}'), 'Tasks should precede Talk');
assert(bottomNav.indexOf('onPress={onTalk}') < bottomNav.indexOf('label="Ask ECOS"'), 'Talk should precede Ask ECOS');
assert(bottomNav.indexOf('label="Ask ECOS"') < bottomNav.indexOf('label="Reports"'), 'Ask ECOS should precede Reports');
