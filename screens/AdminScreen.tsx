...
export function AdminScreen({
  ...
  localProjectOptions: readonly DAVECaptureProjectOption[];
  ...
  const [capturePreviewDraft, setCapturePreviewDraft] = useState<DAVECaptureMemory>(() =>
    createCapturePreviewDraft(DEVELOPER_PREVIEW_PROJECT),
  );
    ...
    <Screen contentStyle={contentStyle}>
                ...
                <SecondaryButton
                  ...
                  onPress={() => {
                    setCapturePreviewDraft(createCapturePreviewDraft(
                      localProjectOptions[0] || DEVELOPER_PREVIEW_PROJECT,
                    ));
      ...
      {__DEV__ ? (
        <DAVECaptureConfirmationSheet
          ...
          projects={localProjectOptions.length
            ? localProjectOptions
            : [DEVELOPER_PREVIEW_PROJECT, DEVELOPER_PREVIEW_ALTERNATE_PROJECT]}
...
const DEVELOPER_PREVIEW_PROJECT = Object.freeze({
  id: 'developer-preview-project-canopy-b',
  name: 'Canopy B',
});
const DEVELOPER_PREVIEW_ALTERNATE_PROJECT = Object.freeze({
  id: 'developer-preview-project-canopy-c',
  name: 'Canopy C',
});

function createCapturePreviewDraft(project: DAVECaptureProjectOption) {
  ...
  return createCaptureMemory({
    ...
    createdAt,
    recommendedProject: { value: project.name, confidence: 'medium' },
