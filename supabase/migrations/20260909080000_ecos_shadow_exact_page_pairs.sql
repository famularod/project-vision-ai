...
create or replace function public.ecos_load_hosted_shadow_page_context_pairs_v22(
  p_project_id text,
  p_document_ids text[],
...
revoke all on function public.ecos_load_hosted_shadow_page_context_pairs_v22(
  text, text[], integer[], integer
) from public, anon, authenticated;
grant execute on function public.ecos_load_hosted_shadow_page_context_pairs_v22(
  text, text[], integer[], integer
) to service_role;
