-- Install the complete customer Ask ECOS proof and project-record contract in one
-- transaction. This migration intentionally does not depend on either partial
-- Build 190/191 proof migration having been applied.
