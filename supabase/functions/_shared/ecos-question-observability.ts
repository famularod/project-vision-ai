...
export function normalizeECOSResponseClientSurface(
  executionSurface: ECOSQuestionClientSurface,
  originatingSurface: unknown,
): Exclude<ECOSQuestionClientSurface, "shadow"> {
  if (executionSurface !== "shadow") return executionSurface;
  return originatingSurface === "web" || originatingSurface === "iphone" ||
      originatingSurface === "ipad" || originatingSurface === "android"
    ? originatingSurface
    : "unknown";
}
