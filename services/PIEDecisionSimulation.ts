...
function buildDelayEvidenceOption(input: PIEDecisionSimulationInput): PIEDecisionOption {
  return {
    ...
    expectedOutcome: 'ECOS can make a stronger recommendation with less uncertainty.',
...
function scenarioOutcome(
  ...
  if (scenarioType === 'visual_progress_not_matching_reported_progress') {
    return 'Visual progress and written status disagree; ECOS lowers confidence and requests targeted confirmation instead of choosing one source silently.';
  }
