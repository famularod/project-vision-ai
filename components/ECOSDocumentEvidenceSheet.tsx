...
export function ECOSDocumentEvidenceSheet({
  ...
  const exactSourceAvailable = Boolean(document);
  return (
      ...
      <View style={styles.backdrop}>
        <View style={styles.sheet}>
          ...
          <View style={styles.header}>
            <View style={styles.main}>
              <Text style={styles.eyebrow}>
                {exactSourceAvailable ? 'ECOS VERIFIED SOURCE' : 'SOURCE UNAVAILABLE'}
              </Text>
          ...
          <ScrollView contentContainerStyle={styles.content}>
            ...
            {exactSourceAvailable && evidence?.excerpt ? (
            ...
            {exactSourceAvailable ? (
              <View style={styles.assuranceCard}>
                ...
                <Text style={styles.assuranceText}>
                  ECOS Assurance matched this text to the current document revision and exact cited page before showing it.
                </Text>
              </View>
            ) : null}
            <TouchableOpacity
