  ...
  return (
    <View style={styles.priorityCard}>
      ...
      <View style={styles.priorityContent}>
        ...
        {item.projectId ? (
          <Link href={{ pathname: '/tasks', params: { project: item.projectName, projectId: item.projectId } }} asChild>
          ...
          <View style={styles.primaryAction} accessibilityRole="text">
            <Text style={styles.primaryActionText}>Project confirmation required</Text>
          </View>
        )}
      </View>
    </View>
...
function OverviewProjectCard({
  ...
  return (
    <Link href={{ pathname: '/', params: { project: project.name, projectId: project.id } }} asChild>
