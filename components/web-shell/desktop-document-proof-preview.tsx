...
export function DesktopDocumentProofPreview({
  ...
  const resolved = useMemo(
    () => focus
      ? resolveECOSDesktopDocumentProof([document], focus, projectIdentities)
      : null,
    [document, focus, projectIdentities],
  );
        ...
        <View style={styles.header}>
          ...
          <View style={styles.main}>
            ...
            <Text style={styles.limited}>
              {binding?.message || 'Refresh project documents and ask ECOS again before relying on this proof.'}
            </Text>
          </View>
        </View>
      </View>
