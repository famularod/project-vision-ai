...
export function DAVETypedCaptureSheet({
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent onRequestClose={onCancel} onDismiss={onDismiss}>
        ...
        >
          ...
          {ecosExperience ? (
            <View style={styles.ecosBrainStage}>
              <ECOSThinkingBrain mode="idle" compact />
...
const styles = StyleSheet.create({
  ...
  ecosBrainTitle: { color: colors.text, fontSize: 18, fontWeight: '900', textAlign: 'center' },
  operationCard: {
    alignItems: 'center',
